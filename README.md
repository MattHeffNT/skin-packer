...
Additionally, in this repo is a batch script (<a href = "https://github.com/MattHeffNT/skin-packer/removeSkins.bat" download>remove skins script</a>) that Windows users can download and use by simply double clicking the file and following through the prompts. The batch script is an easy automated way to delete any custom skinpacks that they user may have imported into Minecraft Education. When I get time I'll add a script for Linux and OSX.
